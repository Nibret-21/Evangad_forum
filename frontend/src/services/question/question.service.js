...
export const searchQuestionsSemantic = async (query) => {
  const response = await apiClient.get("/api/questions/search/semantic", {
    params: {
      query,
      k: 5,
      threshold: 0.75,
...
//     const response = await apiClient.get("/api/questions?mine=true");
//     return response.data;
//   },
...
//       `/api/questions/search?query=${encodeURIComponent(query)}&k=5&threshold=0.5`,
//     );
//     return response.data;
//   },
