...
- **Task Name**: Create Question & Auto-Embed (`T-09`)
  ...
  - **Description**: Implement `POST /api/questions` to save questions and simultaneously generate AI vector embeddings for sem: antic search.
...
- **Task Name**: Post Question Page (`T-15`)
  ...
  - **Description**: Build the `/questions/` form, seamlessly integrating the AI Draft Coach for real-time writing feedback.
  - **Reference**: `/post-question/task-post-question.md`

- **Task Name**: Question Detail Page (`T-16` & `T-20`)

  - **Descriptionask**: Build the `/questions/:questionHash` page to display the question, answers, and the new answer form equipped with AI Answer Fit.
